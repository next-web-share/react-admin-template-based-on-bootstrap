...
const defaultProps = { tag: 'a' };

class NavbarBrand extends Component {
  imgSrc = brand => (brand.src ? brand.src : '');

  imgWidth = brand => (brand.width ? brand.width : 'auto');

  imgHeight = brand => (brand.height ? brand.height : 'auto');

  imgAlt = brand => (brand.alt ? brand.alt : '');
